...
//+kubebuilder:rbac:groups=ops.db.io,resources=stats,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ops.db.io,resources=stats/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ops.db.io,resources=stats/finalizers,verbs=update
